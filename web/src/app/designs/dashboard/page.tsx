    ...
    <div style={{ borderBottom: `1px solid ${t.border}`, background: t.white }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ fontSize: 18, fontWeight: 700, color: t.text, fontFamily: t.font, letterSpacing: -0.5 }}>Nest</span>
    ...
    <div style={{ minHeight: "100vh", background: "#F0F0F0", padding: 48, fontFamily: t.font }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div style={{ marginBottom: 48, textAlign: "center" as const }}>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: t.text, marginBottom: 4 }}>Nest — Dashboard UI States</h1>
          ...
          <PageFrame label="Login" width={500}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 40px" }}>
              <div style={{ width: "100%", maxWidth: 360 }}>
                <h1 style={{ fontSize: 30, fontWeight: 700, textAlign: "center" as const, color: t.text, fontFamily: t.font, marginBottom: 4, letterSpacing: -0.5 }}>Nest</h1>
